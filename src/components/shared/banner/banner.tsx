  ...
  return (
    <div className="banner bg-[linear-gradient(90deg,rgba(91,192,243,0)_0%,rgba(91,192,243,0.2)_56.75%,rgba(91,192,243,0)_109.09%)] px-safe pt-safe">
      <div className="container-narrow">
        <Link
          className={clsx(
            'relative flex h-10 items-center justify-center text-14 xs:h-auto xs:flex-wrap xs:py-[9px] xs:text-13',
        ...
        >
          ...
          <span className="shrink truncate font-semibold">{linkText}</span>
        </Link>
      </div>
    </div>
  );
