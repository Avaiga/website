...
export const ROUTES: Record<string, URL | Route<string>> = {
  ...
  DOCUMENTATION: 'https://docs.taipy.io/en/release-4.0/',
  DOCUMENTATION_APPS_EXAMPLES: 'https://docs.taipy.io/en/release-4.0/gallery/',
  DOCUMENTATION_CONTRIBUTING: 'https://docs.taipy.io/en/release-4.0/contributing/',
  DOCUMENTATION_GETTING_STARTED: 'https://docs.taipy.io/en/release-4.0/tutorials/getting_started/',
  DOCUMENTATION_TUTORIALS: 'https://docs.taipy.io/en/release-4.0/tutorials/articles/understanding_gui/',
  DOCUMENTATION_MANUALS: 'https://docs.taipy.io/en/release-4.0/userman/',
  DOCUMENTATION_RELNOTES: 'https://docs.taipy.io/en/release-4.0/release-notes/',
