  ...
  return (
    <section className="cta my-[202px] px-safe lg:my-32 md:my-24">
      <div className="container-narrow grid max-w-[1088px] grid-cols-2 gap-x-8 text-center md:max-w-[512px] md:grid-cols-1 md:gap-y-6">
        ...
        >
          <h3 className="relative text-36 font-semibold leading-dense tracking-tight lg:text-32 md:text-28">
            Start with Taipy now
          </h3>
          <p className="relative mt-3.5 text-18 font-light lg:mt-3 lg:text-16 md:text-14">
            Python library for building production-ready apps, including other libraries missing
            features
          </p>
          <div className="relative mx-auto mt-6 flex h-12 w-full max-w-[300px] items-center justify-between rounded-full bg-white px-5 md:mt-5">
        ...
        <div className="card-border z-10 rounded-2xl">
          <div className="rounded-2xl bg-grey-10 px-10 py-11 lg:px-9 lg:pb-11 lg:pt-10 md:px-[42px] md:pb-9 md:pt-8">
            <h3 className="text-36 font-semibold leading-dense tracking-tight lg:text-32 md:text-28">
              Taipy Enterprise
            </h3>
            <p className="mt-3.5 text-18 font-light lg:mt-3 lg:text-16 md:text-14">
              Provide security to your app by providing authentication and authorization features
            </p>
            <Button
              className="mt-6 w-full max-w-[180px] md:max-w-40"
              size="lg"
              theme="white-filled"
            >
              Learn more
