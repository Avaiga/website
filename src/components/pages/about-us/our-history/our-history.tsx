...
export default function OurHistory() {
  return (
    <section className="our-history pt-[174px]">
      <div className="container-narrow max-w-[1279px]">
        <div className="w-full">
          ...
          <h2 className="pt-4 text-48 font-medium leading-tight tracking-tight">
            The history of Taipy
          </h2>
        </div>
        <div className="mt-11 flex w-full max-w-[1184px] justify-between">
          <div className="w-full max-w-[576px]">
            <HistoryVideo />
            <ul className="mt-[51px] flex w-full max-w-[371px] justify-between">
