...
function Features() {
  return (
    <section className="features mt-[183px] px-safe lg:mt-[151px] md:mt-[110px]">
      <div className="container flex max-w-[1024px] flex-col items-center lg:max-w-[960px]">
        ...
        <p className="mt-5 max-w-[656px] text-center text-18 leading-snug tracking-snug text-grey-70 lg:text-18 md:mt-4 md:max-w-[640px]">
          Get flexible solutions that fit your environment and give you full control of your
          observability data.
        </p>
        <div className="relative mt-[72px] flex max-w-[1280px] items-center md:mt-[60px]">
          <span className="absolute left-1/2 top-0 z-10 h-full w-1 -translate-x-1/2 bg-[url('/images/svgs/line.inline.svg')] bg-repeat-y before:absolute before:left-1/2 before:h-[120px] before:w-[30px] before:-translate-x-1/2 before:bg-gradient-to-b before:from-black before:to-transparent after:absolute after:bottom-0 after:left-1/2 after:h-[120px] after:w-[30px] after:-translate-x-1/2 after:bg-gradient-to-t after:from-black after:to-transparent" />
          <ul className="flex flex-col gap-y-16 pb-[57px] md:gap-y-[50px]">
            {items.map(({ title, text, image }, index) => (
              ...
              >
                <div
                  className={`w-1/2 ${
                    index % 2 === 0 ? 'pr-20 lg:pr-12 md:pr-[15px]' : 'pl-20 lg:pl-12 md:pl-[15px]'
                  }`}
                >
                ...
                <div
                  className={`w-1/2 ${
                    index % 2 === 0 ? 'pl-20 lg:pl-12 md:pl-[15px]' : 'pr-20 lg:pr-12 md:pr-[15px]'
                  }`}
                >
                  <h3 className="text-20 font-medium leading-dense tracking-tight lg:text-18">
                    {title}
                  </h3>
                  <p className="mt-3 leading-snug text-grey-70 md:text-14 md:leading-normal">
                    {text}
                  </p>
                </div>
              </li>
