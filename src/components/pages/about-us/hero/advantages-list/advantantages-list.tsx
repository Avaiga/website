...
export default function AdvantagesList() {
  return (
    <ul className="mx-auto mt-16 flex w-full max-w-[952px] justify-between gap-6 lg:mt-[49px] lg:max-w-[888px] md:mt-[41px]">
      {advantagesData.map((item, index) => (
        <li className=" relative w-full max-w-[232px] text-center" key={index}>
          ...
          <span className="relative bg-gradient-digit bg-clip-text text-[128px] font-light leading-none tracking-snug text-transparent md:text-[104px]">
            {item.digit}
          </span>
