...
export default function OurTeam() {
  return (
    <section className="our-team pt-[200px] lg:pt-[146px] md:pt-[128px]">
      <div className="container-narrow">
        <div className="mx-auto w-full max-w-[920px] text-center">
          ...
          <h2 className="mx-auto max-w-[899px] pt-4 text-48 font-semibold leading-dense tracking-tight lg:max-w-[820px] lg:pt-3.5 lg:text-44 md:max-w-[680px] md:text-36">
            A great team bringing together AI veterans and talented young developers
          </h2>
          <p className="mx-auto max-w-[680px] pt-4 text-18 font-light leading-snug tracking-snug text-grey-70 lg:pt-5 md:max-w-[628px]">
