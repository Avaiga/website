...
function CTA() {
  ...
  return (
    <section className="cta my-[202px] px-safe lg:my-32">
      <div className="container-narrow grid max-w-[1088px] grid-cols-2 gap-x-8 text-center">
        <div
          className={clsx(
            'relative overflow-hidden rounded-2xl bg-primary-red px-10 pb-12 pt-11 shadow-[0px_12px_40px_0px_#FF462B80] lg:px-9 lg:pb-11 lg:pt-10',
        ...
        >
          <h3 className="relative text-36 font-semibold leading-dense tracking-tight lg:text-32">
            Start with Taipy now
          </h3>
          <p className="relative mt-3.5 text-18 font-light lg:mt-3 lg:text-16">
        ...
        <div className="card-border rounded-2xl">
          <div className="rounded-2xl bg-grey-10 px-10 py-11 lg:px-9 lg:pb-11 lg:pt-10">
            <h3 className="text-36 font-semibold leading-dense tracking-tight lg:text-32">
              Taipy Enterprise
            </h3>
            <p className="mt-3.5 text-18 font-light lg:mt-3 lg:text-16">
