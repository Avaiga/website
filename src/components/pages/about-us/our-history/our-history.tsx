...
export default function OurHistory() {
  return (
    <section className="our-history pt-[155px] lg:pt-[124px]">
      <div className="container-narrow max-w-[1279px]">
        <div className="w-full">
          ...
          <h2 className="pt-4 text-48 font-semibold leading-tight tracking-tight lg:tracking-tight">
        ...
        <div className="mt-11 flex w-full max-w-[1184px] justify-between gap-2.5 lg:mt-10 ">
          ...
          <div className="w-full max-w-[544px] lg:max-w-[480px]">
            <div className="">
