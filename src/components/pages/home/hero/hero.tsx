...
function Hero() {
  return (
    <section className="hero overflow-hidden pt-[136px] px-safe lg:pt-[120px] md:pt-[114px]">
      <div className="container-wide relative">
        ...
        <div className="relative mt-[-9px] lg:mt-7 md:mt-0 md:px-[16px]">
          ...
          />
          <video
            className="absolute inset-x-0 top-[108px] mx-auto rounded-[10px] xl:top-[88px] xl:h-[366px] xl:w-[590px] lg:top-16 lg:h-[268px] lg:w-[431px] md:top-[18.5%] md:h-auto md:w-[74%]"
            controls={false}
            width={732}
            height={454}
            loop
