...
export const ROUTES: Record<string, URL | Route<string>> = {
  ...
  DOCUMENTATION_GETTING_STARTED: 'https://docs.taipy.io/en/latest/tutorials/getting_started/',
  DOCUMENTATION_TUTORIALS: 'https://docs.taipy.io/en/latest/tutorials/articles/understanding_gui/',
  DOCUMENTATION_MANUALS: 'https://docs.taipy.io/en/latest/userman/',
